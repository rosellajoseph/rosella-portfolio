        ...
        <section id="summary" className="mb-16 scroll-mt-24">
          ...
          <div className="bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 rounded-2xl shadow-xl p-8 border-4 border-purple-200 transform hover:scale-105 transition-transform">
            <p className="text-slate-800 leading-relaxed text-lg font-medium">
              ...
              <span className="bg-yellow-200 px-2 py-1 rounded font-bold"> Information Science & Technology graduate</span> who loves
              ...
              <span className="text-green-600 font-bold"> web application development</span>. I've created projects like
              <span className="text-orange-600 font-bold"> image watermarking systems</span> and
              <span className="text-purple-600 font-bold"> e-commerce websites</span> for my degree!
              <br/><br/>
              🎯 Currently seeking opportunities where I can apply what I've learned,
              continue growing my technical skills, and contribute to a great team in IT or cybersecurity. Let's connect!
            </p>
          </div>
        </section>
